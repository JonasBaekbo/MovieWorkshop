package com.example.movieworkshop.resources;
...
public class FileReader {
    ...
    public String getFirst() throws IOException {
        String line = Files.readAllLines(Paths.get(String.valueOf(movies))).get(1);
    ...
    public String getRandomMovie() throws IOException {
        ...
        String line = Files.readAllLines(Paths.get(String.valueOf(movies))).get(randomNumber);
        String[] stringAsArray = line.split(";");
        return stringAsArray[2];
    }
    ...
    public ArrayList<Movie> getTenSortByPopularity() throws IOException {
        ...
        for (int i = 0; i < 10; i++) {
            int randomNumber = r.nextInt(1575) + 1;
            String line = Files.readAllLines(Paths.get(String.valueOf(this.movies))).get(randomNumber);
            String[] stringAsArray = line.split(";");
